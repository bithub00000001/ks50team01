! function(t, e) {
    ...
    return function(t) {
            ...
            e[i ? "eachComponent" : "eachSeries"](function(t, r) {
                ...
                if (!l) {
                    var h = _.parseClassType(r.type),
                        u = i ? w.getClass(h.main, h.sub) : S.getClass(h.sub);
                    if (!u) return;
                ...
                this._zr.on(t, function(e) {
                    ...
                    if (n && null != n.dataIndex) {
                        var o = n.dataModel || i.getSeriesByIndex(n.seriesIndex),
                            a = o && o.getDataParams(n.dataIndex, n.dataType) || {};
        ...
        function g(t, e, i, n, o, a) {
            ...
            var r = t ? "Update" : "",
                s = n && n.getShallow("animationDuration" + r),
                l = n && n.getShallow("animationEasing" + r),
                h = n && n.getShallow("animationDelay" + r);
        ...
        a.prototype = {
            ...
            brush: function(t) {
                ...
                var e = this.style,
                    ...
                    a = o(e),
                    r = n(e),
                    s = r && !!e.fill.colorStops,
                    l = a && !!e.stroke.colorStops;
        ...
        function l(t, e) {
            ...
            for (var r = 0; i > r; r++)
                for (var l = 0; l < n.length; l++) t = t.replace(s(f[l], r), e[r][n[l]]);
            return t
        }
        ...
        }), s.enableSubTypeDefaulter(u), s.enableTopologicalTravel(u, n), a.mixin(u, i(115)), t.exports = u
    }, function(t, e, i) {
        "use strict";
        ...
        n.prototype = {
            ...
            getModel: function(t, e) {
                var i = this.get(t, !0),
                    o = this.parentModel,
                    a = new n(i, e || o && o.getModel(t), this.ecModel);
                return a
            },
            isEmpty: function() {
        ...
        var n = i(1),
            ...
            h = r.extend({
                ...
                fillDataTextStyle: function(t) {
                    if (t)
                        for (var e = 0; e < t.length; e++) t[e] && t[e].label && a.defaultEmphasis(t[e].label, a.LABEL_OPTIONS)
                },
                ...
                formatTooltip: function(t, e, i) {
                    var o = this._data,
                        ...
                        r = n.isArray(a) ? n.map(a, l).join(", ") : l(a),
                        h = o.getName(t),
        ...
        (function(e) {
            ...
            var a = "undefined",
                ...
                s = typeof r.Float64Array === a ? Array : r.Float64Array,
                l = typeof r.Int32Array === a ? Array : r.Int32Array,
                h = {
                    "float": s,
                    "int": l,
                    ordinal: Array,
            ...
            y.type = "list", y.getDimension = function(t) {
                ...
                for (var e = this.dimensions, i = this._dimensionInfos, n = 0, o = e.length; o > n; n++)
                ...
                var i = this._storage[t],
                    n = 0;
                if (i)
                    for (var o = 0, a = this.count(); a > o; o++) {
                ...
                for (var l = 0; l < s.length; l++)
                    if (0 === r) e.call(o, l);
                    else if (1 === r) e.call(o, this.get(t[0], l, i), l);
                else {
                ...
                for (var h = 0; h < l.length; h++) {
                    var u;
                    if (1 === s) u = e.call(o, this.get(t[0], h, i), h);
                    else {
            ...
            if (n(c) && n(d))
                ...
                if (n(m)) {
                    ...
                    var I = (2 * c * l - 3 * s * d) / (2 * b(c * c * c)),
                        ...
                        C = Math.cos(T),
                        g = (-l - 2 * L * C) / (3 * s),
                        y = (-l + L * (C + M * Math.sin(T))) / (3 * s),
                        D = (-l + L * (C - M * Math.sin(T))) / (3 * s);
        ...
        function u(t) {
            var e = (parseFloat(t[0]) % 360 + 360) % 360 / 360,
                ...
                a = .5 >= o ? o * (n + 1) : o + n - o * n,
                l = 2 * o - a,
                h = [i(255 * s(l, a, e + 1 / 3)), i(255 * s(l, a, e)), i(255 * s(l, a, e - 1 / 3))];
        ...
        function g(t, e, n) {
            if (e && e.length && t >= 0 && 1 >= t) {
                var a = t * (e.length - 1),
                    ...
                    c = h(e[s]),
                    d = a - r,
                    f = y([i(l(u[0], c[0], d)), i(l(u[1], c[1], d)), i(l(u[2], c[2], d)), o(l(u[3], c[3], d))], "rgba");
                return n ? {
                    color: f,
                    leftIndex: r,
                    rightIndex: s,
            ...
            l = a.extend({
                ...
                getTicks: function() {
                    ...
                    if (t) {
                        ...
                        e[0] < a[0] && i.push(e[0]);
                        for (var r = a[0]; r <= a[1];)
                            if (i.push(r), r = n.round(r + t), i.length > o) return [];
                        e[1] > a[1] && i.push(e[1])
                    }
                    return i
                },
                ...
                niceTicks: function(t) {
                    ...
                    if (isFinite(i)) {
                        0 > i && (i = -i, e.reverse());
                        var o = n.nice(i / t, !0),
                            a = [n.round(s(e[0] / o) * o), n.round(r(e[1] / o) * o)];
        ...
        s.updateData = function(t, e) {
            ...
            t.diff(r).add(function(n) {
                ...
                var u = r.getItemGraphicEl(h),
                    c = t.getItemLayout(l);
                return o(t, l, e) ? (u ? (u.updateData(t, l), a.updateProps(u, {
                    position: c
                ...
                _giveAxisProxies: function() {
                    ...
                    this.eachTargetAxis(function(e, i, n, o) {
                        var a = this.dependentModels[e.axis][i],
                            r = a.__dzAxisProxy || (a.__dzAxisProxy = new h(e.name, i, this, o));
                        t[e.name + "_" + i] = r
                    }, this)
                },
                    ...
                    t && c(function(e) {
                        if (t) {
                            ...
                            if (o.length && !n.length)
                                for (var a = 0, r = o.length; r > a; a++) "category" === o[a].get("type") && n.push(a);
        ...
        u._createSymbol = function(t, e, i) {
            ...
            l.initProps(h, {
                scale: u
            }, o, i), this._symbolType = t, this.add(h)
            ...
            execute: function() {
                ...
                for (var l in s)
                    if (s.hasOwnProperty(l)) {
                        ...
                        if (null == h) continue;
                        if (h.length)
                            for (var t = 0, u = h.length; u > t; t++) this._add && this._add(h[t]);
        ...
        var p = {
                ...
                axisTick: function() {
                    ...
                    if (t.get("axisTick.show")) {
                        for (var e = t.axis, i = t.getModel("axisTick"), n = this.opt, o = i.getModel("lineStyle"), a = i.get("length"), r = m(i, n.labelInterval), l = e.getTicksCoords(), h = [], u = 0; u < l.length; u++)
                            if (!g(e, u, r)) {
                                var c = l[u];
                ...
                axisLabel: function() {
                    ...
                    if (e.get("axisLabel.show")) {
                        ...
                        for (var m = o(i, p, i.labelDirection), v = e.get("data"), y = [], x = e.get("silent"), _ = 0; _ < c.length; _++)
                            if (!g(a, _, i.labelInterval)) {
                                var b = h;
                                v && v[_] && v[_].textStyle && (b = new l(v[_].textStyle, h, e.ecModel));
                                var w = b.getTextColor(),
                                    S = a.dataToCoord(c[_]),
                                    M = [S, i.labelOffset + i.labelDirection * u],
                                    A = a.scale.getLabel(c[_]),
                                    I = new s.Text({
                                        style: {
                                            text: f[_],
        ...
        g.type = "grid", g.getRect = function() {
            ...
            function o(i) {
                return function(o, h) {
                    if (n(o, t, e)) {
                        ...
                        var d = new c(i, l.createScaleByModel(o), [0, 0], o.get("type"), u),
                            f = "category" === d.type;
            ...
            h.each(this._axesList, function(t) {
                ...
                if ("cartesian2d" === o.get("coordinateSystem")) {
                    var a = o.get("xAxisIndex"),
                        r = o.get("yAxisIndex"),
                        s = t.getComponent("xAxis", a),
                        l = t.getComponent("yAxis", r);
                    if (!n(s, e, t) || !n(l, e, t)) return;
                    var h = this.getCartesian(a, r),
                        u = o.getData(),
                        c = h.getAxis("x"),
                        d = h.getAxis("y");
        ...
        var s = r.prototype;
        s.updateView = s.updateLayout = s.updateVisual = function(t, e, i, n) {}, a.enableClassExtend(r), a.enableClassManagement(r, {
            registerWhenExtend: !0
        }), t.exports = r
    }, function(t, e, i) {
        "use strict";
        ...
        function s(t, e, i, n, o) {
            var r = t.length;
            if (1 == o)
                for (var s = 0; r > s; s++) n[s] = a(t[s], e[s], i);
            else
                for (var l = t[0].length, s = 0; r > s; s++)
                    for (var h = 0; l > h; h++) n[s][h] = a(t[s][h], e[s][h], i)
        }
        ...
        function l(t, e, i) {
            ...
            if (n !== o) {
                ...
                if (a) t.length = o;
                    ...
                    for (var r = n; o > r; r++) t.push(1 === i ? e[r] : x.call(e[r]))
            }
        ...
        function h(t, e, i) {
            ...
            if (1 === i) {
                ...
                for (var a = t[0].length, o = 0; n > o; o++)
                    for (var r = 0; a > r; r++)
        ...
        function u(t, e, i, n, o, a, r, s, l) {
            var h = t.length;
            if (1 == l)
                for (var u = 0; h > u; u++) s[u] = c(t[u], e[u], i[u], n[u], o, a, r);
            else
                for (var d = t[0].length, u = 0; h > u; u++)
                    for (var f = 0; d > f; f++) s[u][f] = c(t[u][f], e[u][f], i[u][f], n[u][f], o, a, r)
        }
            ...
            if (x) {
                ...
                if (!C) {
                    ...
                    var W = function(t, e) {
                            ...
                            if (0 !== n)
                                if (O = (e - I[i]) / n, v)
                                    if (V = T[i], R = T[0 === i ? i : i - 1], N = T[i > x - 2 ? x - 1 : i + 1], B = T[i > x - 3 ? x - 1 : i + 2], w) u(R, V, N, B, O, O * O, O * O * O, d(t, o), A);
                                    else {
                                        var l;
                                        if (S) l = u(R, V, N, B, O, O * O, O * O * O, H, 1), l = f(H);
                                        else {
                                            if (M) return r(V, N, O);
                            ...
                            else if (w) s(T[i], T[i + 1], O, d(t, o), A);
                            else {
                                var l;
                                if (S) s(T[i], T[i + 1], O, H, 1), l = f(H);
                                else {
                ...
                if (!e.isSeriesFiltered(t)) {
                    ...
                    r.each(function(t) {
                        ...
                        if (l) a.setItemVisual(s, "color", l);
                            ...
                            var h = o ? o[s % o.length] : i[(s + n) % i.length],
        ...
        t.exports = function(t, e, i) {
            function o(t) {
                var o = [e, "normal", "color"],
                    a = i.get("color"),
                    r = t.getData(),
                    s = t.get(o) || a[t.seriesIndex % a.length];
        ...
        var o = i(1),
            a = ["getDom", "getZr", "getWidth", "getHeight", "dispatchAction", "on", "off", "getDataURL", "getConnectedDataURL", "getModel", "getOption"];
        t.exports = n
    }, function(t, e, i) {
        var n = i(1);
        i(52), i(80), i(81);
                ...
                function r(e, i) {
                    ...
                    if (f) {
                        var u = h.shape,
                            c = d ? "height" : "width",
                            g = {};
                        u[c] = 0, g[c] = r[c], a[i ? "updateProps" : "initProps"](h, {
                            shape: g
                        }, t, e)
                    }
                    return h
            ...
            if (e || i || !n.ignore) {
                ...
                if (this.__dirty || r.__dirty) {
                    ...
                    if (!n.ignore) {
                        n.attr("position", h);
                        var f, p, g, m = 5 * o;
                        if ("end" === n.__position) f = [c[0] * m + h[0], c[1] * m + h[1]], p = c[0] > .8 ? "left" : c[0] < -.8 ? "right" : "center", g = c[1] > .8 ? "top" : c[1] < -.8 ? "bottom" : "middle";
        ...
        m.beforeUpdate = s, m._createLine = function(t, e) {
            var i = t.hostModel,
                r = t.getItemLayout(e),
                s = a(r);
            s.shape.percent = 0, d.initProps(s, {
                shape: {
                    percent: 1
                }
            }, i, e), this.add(s);
            ...
            var i = t.hostModel,
                ...
                r = a.getModel("textStyle"),
                s = o.getModel("label.emphasis"),
            ...
            var u = t.getItemVisual(e, "color") || "#000",
                c = this.childOfName("label");
            c.setStyle({
        ...
        function h(t, e, i) {
            ...
            return e && (f.shape[r ? "width" : "height"] = 0, m.initProps(f, {
                shape: {
                    width: h,
                    height: u
                }
        ...
        t.exports = y.extend({
            ...
            render: function(t, e, i) {
                var a = t.coordinateSystem,
                    ...
                    w = s(a, l),
                    S = t.get("showSymbol"),
                    M = S && !p && !t.get("showAllSymbol") && this._getSymbolIgnoreFunc(l, a),
                    A = this._data;
                A && A.eachItemGraphicEl(function(t, e) {
                    ...
                    t.stopAnimation(!0)
                }), n(this._stackedOnPoints, w) && n(this._points, f) || (_ ? this._updateAnimation(l, w, a, i) : (v.setShape({
                    points: f
                }), y && y.setShape({
                    points: f,
                    stackedOnPoints: w
            ...
            _updateAnimation: function(t, e, i, n) {
                ...
                o.shape.points = s.current, m.updateProps(o, {
                    shape: {
                        points: s.next
                    }
                }, r), a && (a.setShape({
        ...
        function o(t, e, i, o, a, r, g, m, v, y, x) {
            for (var _ = 0, b = i, w = 0; o > w; w++) {
                ...
                if (b === i) t[r > 0 ? "moveTo" : "lineTo"](S[0], S[1]), c(f, S);
                else if (v > 0) {
                    var M = b + r,
                        A = e[M];
                    if (x)
                        for (; A && n(e[M]);) M += r, A = e[M];
                    var I = .5,
                        T = e[_],
                        A = e[M];
                    if (!A || n(A)) c(p, S);
        ...
        h.updateData = function(t, e, i) {
            ...
            r.useStyle(l.defaults({
                fill: p
            }, f.getModel("normal").getItemStyle())), r.hoverStyle = f.getModel("emphasis").getItemStyle(), o(this, t.getItemLayout(e), u.get("selected"), h.get("selectedOffset"), h.get("animation")), r.off("mouseover").off("mouseout").off("emphasis").off("normal"), u.get("hoverAnimation") && r.on("mouseover", n).on("mouseout", a).on("emphasis", n).on("normal", a), this._updateLabel(t, e), s.setHoverStyle(this)
            ...
            var c = a.getModel("label.normal"),
                d = a.getModel("label.emphasis"),
                f = a.getModel("labelLine.normal"),
                p = a.getModel("labelLine.emphasis"),
        ...
        function n(t, e, i, n, o, a, r) {
            function s(e, i, n, o) {
                for (var a = e; i > a; a++)
                    if (t[a].y += n, a > e && i > a + 1 && t[a + 1].y > t[a].y + t[a].height) return void l(a, n / 2);
                l(i - 1, n / 2)
            }
            ...
            function h(t, e, i, n, o, a) {
                for (var r = a > 0 ? e ? Number.MAX_VALUE : 0 : e ? Number.MAX_VALUE : 0, s = 0, l = t.length; l > s; s++)
                    if ("center" !== t[s].position) {
                        var h = Math.abs(t[s].y - n),
                            u = t[s].len,
                            c = t[s].len2,
                            d = o + u > h ? Math.sqrt((o + u + c) * (o + u + c) - h * h) : Math.abs(t[s].x - i);
            ...
            c = i(2).extendComponentView({
                ...
                _splitLine: function(t, e, i) {
                    var n = t.axis,
                        ...
                        d = l(r, i);
                    c = o.isArray(c) ? c : [c];
                    for (var f = e.coordinateSystem.getRect(), p = n.isHorizontal(), g = [], m = 0, v = n.getTicksCoords(), y = [], x = [], _ = 0; _ < v.length; _++)
                        if (!s(n, _, d)) {
            ...
            u = function(t, e) {
                ...
                if (e && (isNaN(parseFloat(e.x)) || isNaN(parseFloat(e.y))) && !a.isArray(e.coord) && n) {
                    ...
                    if (e = a.clone(e), e.type && h[e.type] && o.baseAxis && o.valueAxis) {
                        var r = n.dimensions,
                            l = s(r, o.baseAxis.dim),
                            u = s(r, o.valueAxis.dim);
        ...
        function a(t, e, i) {
            ...
            e.eachSeriesByType(t, function(t) {
                var e = t.getData(),
                    ...
                    f = o.onZero ? c.toGlobalCoord(c.dataToCoord(0)) : c.getGlobalExtent()[0],
        ...
        function r(t, e) {
            ...
            p(e, function(t, e) {
                ...
                var n = t.exist,
                    ...
                    a = t.keyInfo;
                if (x(o)) {
                    if (a.name = null != o.name ? o.name + "" : n ? n.name : "\x00-", n) a.id = n.id;
            ...
            S = f.extend({
                ...
                findComponents: function(t) {
                    ...
                    var n = t.query,
                        o = t.mainType,
                        a = e(n),
                        r = a ? this.queryComponents(a) : this._componentsMap[o];
                    return i(h(r, t))
                },
        ...
        t.exports = function(t) {
            if (t) {
                ...
                if (e) {
                    ...
                    var a = t.markPoint;
                    if (a && a.data)
                        for (var r = a.data, i = 0; i < r.length; i++) n(r[i]);
                    var s = t.markLine;
                    if (s && s.data)
        ...
        v.prototype = {
            ...
            _updateLayerStatus: function(t) {
                ...
                for (var n = 0, o = t.length; o > n; n++) {
                    var a = t[n],
                        r = this._singleCanvas ? 0 : a.zlevel,
                        s = e[r];
                    if (s) {
        ...
        var n = i(1),
            o = i(34).Dispatcher,
            a = "undefined" != typeof window && (window.requestAnimationFrame || window.msRequestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame) || function(t) {
                setTimeout(t, 16)
            },
            r = i(56),
            s = function(t) {
                t = t || {}, this.stage = t.stage || {}, this.onframe = t.onframe || function() {}, this._clips = [], this._running = !1, this._time = 0, o.call(this)
            };
        s.prototype = {
            constructor: s,
            addClip: function(t) {
        ...
        n.prototype = {
            ...
            createLinearGradient: function(t, e, i) {
                var n = e.x * i.width + i.x,
                    ...
                    a = e.y * i.height + i.y,
                    r = e.y2 * i.height + i.y,
                    s = t.createLinearGradient(n, a, o, r);
                return s
            },
            createRadialGradient: function(t, e, i) {
                var n = i.width,
                    ...
                    s = e.y * o + i.y,
                    l = e.r * a,
                    h = t.createRadialGradient(r, s, 0, r, s, l);
                return h
            },
        ...
        var o = i(16),
            a = i(5),
            r = o.quadraticSubdivide,
            s = o.cubicSubdivide,
            l = o.quadraticAt,
            h = o.cubicAt,
            u = o.quadraticDerivativeAt,
        ...
        h.prototype = {
            ...
            _animateToShallow: function(t, e, i, n, a) {
                var r = {},
                    l = 0;
                for (var h in i)
                    if (null != e[h]) s(i[h]) && !o.isArrayLike(i[h]) ? this._animateToShallow(t ? t + "." + h : h, e[h], i[h], n, a) : (r[h] = i[h], l++);
                    else if (null != i[h])
                    if (t) {
                        var u = {};
        ...
        function n(t, e, i, n, o, a, r, s, l, h, u) {
            var g = l * (p / 180),
                ...
                _ = y * y / (r * r) + x * x / (s * s);
            _ > 1 && (r *= c(_), s *= c(_));
            var b = (o === a ? -1 : 1) * c((r * r * (s * s) - r * r * (x * x) - s * s * (y * y)) / (r * r * (x * x) + s * s * (y * y))) || 0,
                w = b * r * x / s,
                S = b * -s * y / r,
                M = (t + i) / 2 + f(g) * w - d(g) * S,
                A = (e + n) / 2 + d(g) * w + f(g) * S,
        ...
        function s(t) {
            if (!(this._disabled || t.target && t.target.draggable)) {
                ...
                var e = t.offsetX,
                    i = t.offsetY;
                a.call(this, e, i) && (this._dragging = !0, this._track = [
                    [e, i]
                ])
            }
        }
        ...
        var r = i(328),
            ...
            c = i(2);
        c.registerMap = u.registerMap, c.getMap = u.getMap, c.loadMap = function() {}, c.registerCoordinateSystem("geo", u), t.exports = u
    }, function(t, e, i) {
        function n() {
            this.group = new o.Group, this._symbolEl = new s({
                silent: !0
            })
        }
        var o = i(3),
        ...
        function r(t, e) {
            ...
            if (n) {
                var a = e || 0 === n[0] && 100 === n[1],
                    r = !e && l.getPixelPrecision(o, [0, 500]),
                    s = !(e || 20 > r && r >= 0),
                    h = e || a || s;
        ...
        var o = i(1),
            ...
            w = "vertical",
            S = 5,
            M = ["line", "bar", "candlestick", "scatter"],
            A = s.extend({
                type: "dataZoom.slider",
                init: function(t, e) {
                        ...
                        return t.eachTargetAxis(function(r, s) {
                            ...
                            o.each(l, function(t) {
                                if (!(i || e !== !0 && o.indexOf(M, t.get("type")) < 0)) {
                                    var l = n(r.name),
                                        h = a.getComponent(r.axis, s).axis;
                                    i = {
                                        thisAxis: h,
                                        series: t,
                                        thisDim: r.name,
            ...
            g = {
                ...
                shouldRecordRange: function(t, e) {
                    if (t && "dataZoom" === t.type && t.batch)
                        for (var i = 0, n = t.batch.length; n > i; i++)
        ...
        function r(t, e, i, o, a, r, s) {
            var l, h = r.coordinateSystem,
                u = t.getItemModel(e),
                c = u.get("x"),
                f = u.get("y");
            if (null != c && null != f) l = [d.parsePercent(c, s.getWidth()), d.parsePercent(f, s.getHeight())];
            else {
                if (r.getMarkerPosition) l = r.getMarkerPosition(t.getValues(t.dimensions, e));
                else {
                    var p = h.dimensions,
                        g = t.get(p[0], e),
                        m = t.get(p[1], e);
        ...
        function s(t, e, i) {
            ...
            var o = new h(n, i),
                r = new h(n, i),
                s = new h([], i),
                u = l.map(i.get("data"), l.curry(v, e, t, i));
        ...
        var l = i(1),
            ...
            v = function(t, e, i, n) {
                ...
                if (!l.isArray(n) && ("min" === a || "max" === a || "average" === a || null != n.xAxis || null != n.yAxis)) {
                    var r, s, h;
                    if (null != n.yAxis || null != n.xAxis) s = null != n.yAxis ? "y" : "x", r = e.getAxis(s), h = l.retrieve(n.yAxis, n.xAxis);
                    else {
        ...
        l.defaults(y, c.dataFormatMixin), i(2).extendComponentView({
            ...
            _renderSeriesML: function(t, e, i, n) {
                ...
                l.isArray(x) || (x = [x, x]), "number" == typeof _ && (_ = [_, _]), f.from.each(function(t) {
                    ...
                    }), v.setItemLayout(t, [p.getItemLayout(t), g.getItemLayout(t)]), v.setItemVisual(t, {
        ...
        function n(t, e, i) {
            ...
            t.each(function(o) {
                var a, r = t.getItemModel(o),
                    s = r.getShallow("x"),
                    l = r.getShallow("y");
                if (null != s && null != l) a = [h.parsePercent(s, i.getWidth()), h.parsePercent(l, i.getHeight())];
                else if (e.getMarkerPosition) a = e.getMarkerPosition(t.getValues(t.dimensions, o));
                else if (n) {
        ...
        function o(t, e, i) {
            ...
            var o = new d(n, i),
                a = r.map(i.get("data"), r.curry(f.dataTransform, e));
                    ...
                    if (f.removeAll(), t.get("show")) {
                        ...
                        a.each(g, function(t, e) {
                            ...
                            var e = t.__title,
                                n = t.hoverStyle;
                            if (n && e) {
                                var o = u.getBoundingRect(e, n.font),
        ...
        function r(t, e) {
            ...
            if (n.intersect(i.getRect())) {
                var o = i.getCartesian(e[0].axisIndex, e[1].axisIndex),
                    a = o.pointToData([t[0][0], t[1][0]], !0),
                    r = o.pointToData([t[0][1], t[1][1]], !0);
        ...
        i(200), i(201), i(2).registerAction({
            type: "showTip",
            event: "showTip",
            update: "none"
        ...
        function h(t, e, i, n, o, a, r) {
            var h = r.getWidth(),
                u = r.getHeight(),
                c = a && a.getBoundingRect().clone();
            if (a && c.applyTransform(a.transform), "function" == typeof t && (t = t([e, i], o, n.el, c)), f.isArray(t)) e = m(t[0], h), i = m(t[1], u);
        ...
        i(2).extendComponentView({
            ...
            _tryShow: function(t) {
                ...
                if (i)
                    if (this._lastX = t.offsetX, this._lastY = t.offsetY, e && null != e.dataIndex) {
                        var r = e.dataModel || o.getSeriesByIndex(e.seriesIndex),
                            s = e.dataIndex,
            ...
            _showAxisTooltip: function(t, e, i) {
                ...
                f.each(this._seriesGroupByAxis, function(t) {
                    ...
                    var p = !1,
                        g = this._lastHover;
                    if ("cross" === a) n(g.data, u) && (p = !0), g.data = u;
                    else {
                        var m = f.indexOf(l, d);
            ...
            _showCartesianPointer: function(t, e, i, n) {
                function r(i, n, a) {
                    var r = "x" === i ? o(n[0], a[0], n[0], a[1]) : o(a[0], n[1], a[1], n[1]),
                ...
                function s(i, n, o) {
                    var r = e.getAxis(i),
                        s = r.getBandWidth(),
                        h = o[1] - o[0],
                        c = "x" === i ? a(n[0] - s / 2, o[0], s, h) : a(o[0], n[1] - s / 2, h, s),
            ...
            _showSinglePointer: function(t, e, i, n) {
                function a(i, n, a) {
                    var s = e.getAxis(),
                        h = s.orient,
                        u = "horizontal" === h ? o(n[0], a[0], n[0], a[1]) : o(a[0], n[1], a[1], n[1]),
            ...
            _showPolarPointer: function(t, e, i, n) {
                ...
                var l = this,
                    ...
                    c = e.getRadiusAxis(),
                    f = "cross" !== h;
                if ("cross" === h) a("angle", n, c.getExtent()), a("radius", n, u.getExtent()), this._updateCrossText(e, n, t);
                else {
                    ...
                    if (a) {
                        ...
                        if (m && !n && (K.copy(e), K.applyTransform(m), e = K), n) r = e.x, l = e.y;
                            ...
                            var v = o.textPosition,
                                y = o.textDistance;
                            if (v instanceof Array) r = e.x + E(v[0], e.width), l = e.y + E(v[1], e.height), h = h || "left", d = d || "top";
                            else {
        ...
        t.exports = function(t, e, i, u, c) {
            ...
            if ("cartesian2d" === _ || "polar" === _) x = h(t, i, i.ecModel);
            else {
                var b = s.get(_),
                    w = r((b && "view" !== b.type ? b.dimensions || [] : []).concat(["value"]), t);
        ...
        r.prototype = {
            ...
            draw: function(t, e, i, r, s) {
                ...
                h.each(c.regions, function(e) {
                    ...
                    i.add(o);
                    var a, r = t.getRegionModel(e.name) || t,
                        s = r.getModel(g),
                        c = r.getModel(m),
                        p = n(s, f),
                        x = n(c, f),
                    ...
                    var A = _.get("show"),
                        I = b.get("show"),
                        T = u && isNaN(u.get("value", a)),
                        L = u && u.getItemLayout(a);
            ...
            _updateController: function(t, e, i) {
                ...
                a.off("pan").on("pan", function(t, e) {
                    i.dispatchAction(h.extend(n(), {
                        dx: t,
                        dy: e
                    }))
                }), a.off("zoom").on("zoom", function(t, e, o) {
                    if (i.dispatchAction(h.extend(n(), {
                            zoom: t,
                            originX: e,
                            originY: o
                        })), this._updateGroup) {
                ...
                completeVisualOption: function() {
                    ...
                    function i(t) {
                        ...
                        p(this.stateList, function(a) {
                            ...
                            s || (s = t[a] = {
                                color: d ? n : [n]
                            }), null == s.symbol && (s.symbol = e && o.clone(e) || (d ? "roundRect" : ["roundRect"])), null == s.symbolSize && (s.symbolSize = i && o.clone(i) || (d ? r[0] : [r[0], r[0]])), s.symbol = u(s.symbol, function(t) {
        ...
        t.exports = n.extendComponentView({
            ...
            getControllerVisual: function(t, e, i) {
                ...
                var c = s.controllerVisuals[r || s.getValueState(t)],
            ...
            r = {
                getItemAlign: function(t, e, i) {
                    ...
                    for (var r = {
                            width: e.getWidth(),
                            height: e.getHeight()
                        }, s = "horizontal" === o.orient ? 1 : 0, l = [
                            ["left", "right", "width"],
                            ["top", "bottom", "height"]
                        ], h = l[s], u = [0, null, 10], c = {}, d = 0; 3 > d; d++) c[l[1 - s][d]] = u[d], c[h[d]] = 2 === d ? i[0] : o[h[d]];
                    var f = [
                            ["x", "width", 3],
                            ["y", "height", 0]
                        ][s],
                        p = n.getLayoutRect(c, r, o.padding);
        ...
        n.prototype = {
            ...
            transformTo: function(t, e, i, n) {
                var o = this.getBoundingRect(),
                    r = o.width / o.height;
                i ? n || (n = i / r) : i = r * n;
                for (var l = new a(t, e, i, n), h = o.calculateTransform(l), u = this.contours, c = 0; c < u.length; c++)
                    for (var d = 0; d < u[c].length; d++) s.applyTransform(u[c][d], u[c][d], h);
        ...
        function n(t) {
            ...
            i || (i = {
                ...
                main: "data"
            }), t.datas = t.mainData = null, h(e, i, t), d(i, function(i) {
        ...
        s.updateData = function(t, e, i) {
            ...
            n.setStyle(r.defaults({
                fill: d
            }, c.getModel("normal").getItemStyle(["opacity"]))), n.hoverStyle = c.getModel("emphasis").getItemStyle(), this._updateLabel(t, e), a.setHoverStyle(this)
        ...
        function a(t) {
            t.each(function(e) {
                ...
                if (d) n = (c[0][0] + c[1][0] + c[2][0] + c[3][0]) / 4, o = (c[0][1] + c[1][1] + c[2][1] + c[3][1]) / 4, i = "center", a = [
                    [n, o],
                    [n, o]
                ];
                else {
            ...
            u = i(26).extend({
                ...
                _renderMain: function(t, e, i, n, o) {
                    for (var a = this.group, s = t.getModel("axisLine"), l = s.getModel("lineStyle"), u = t.get("clockwise"), c = -t.get("startAngle") / 180 * Math.PI, d = -t.get("endAngle") / 180 * Math.PI, f = (d - c) % h, p = c, g = l.get("width"), m = 0; m < n.length; m++) {
                        ...
                        y.setStyle({
                            fill: n[m][1]
                        }), y.setStyle(l.getLineStyle(["color", "borderWidth", "borderColor"])), a.add(y), p = d
                    }
                    var x = function(t) {
                        if (0 >= t) return n[0][1];
                ...
                _renderTicks: function(t, e, i, n, a, h, u, c) {
                    for (var d = this.group, f = a.cx, p = a.cy, g = a.r, m = t.get("min"), v = t.get("max"), y = t.getModel("splitLine"), x = t.getModel("axisTick"), _ = t.getModel("axisLabel"), b = t.get("splitNumber"), w = x.get("splitNumber"), S = l(y.get("length"), g), M = l(x.get("length"), g), A = h, I = (u - h) / b, T = I / w, L = y.getModel("lineStyle").getLineStyle(), C = x.getModel("lineStyle").getLineStyle(), D = _.getModel("textStyle"), P = 0; b >= P; P++) {
                        ...
                        if (y.get("show")) {
                            ...
                            "auto" === L.stroke && E.setStyle({
                                stroke: n(P / b)
                            }), d.add(E)
                        }
                        if (_.get("show")) {
                            var O = o(s.round(P / b * (v - m) + m), _.get("formatter")),
                                R = new r.Text({
                                    style: {
                                        text: O,
                                        x: k * (g - S - 5) + f,
                ...
                _renderDetail: function(t, e, i, n, a) {
                    var h = t.getModel("detail"),
                        u = t.get("min"),
                        c = t.get("max");
                    if (h.get("show")) {
                        var d = h.getModel("textStyle"),
                            f = h.get("offsetCenter"),
                            p = a.cx + l(f[0], a.r),
                            g = a.cy + l(f[1], a.r),
                            m = l(h.get("width"), a.r),
                            v = l(h.get("height"), a.r),
        ...
        var n = i(2),
            o = i(1);
        i(249), i(250), i(259), n.registerProcessor("filter", i(252)), n.registerVisualCoding("chart", o.curry(i(44), "graph", "circle", null)), n.registerVisualCoding("chart", i(253)), n.registerVisualCoding("chart", i(256)), n.registerLayout(i(260)), n.registerLayout(i(254)), n.registerLayout(i(258)), n.registerCoordinateSystem("graphView", {
            create: i(255)
        })
    }, function(t, e, i) {
        "use strict";
            ...
            t.eachSeriesByType("graph", function(t) {
                ...
                i.each(function(t) {
                    ...
                    var n = i.getItemModel(t),
                        a = i.getRawIndex(t),
                        r = n.get("itemStyle.normal.color") || e[a % e.length];
            ...
            t.eachSeriesByType("graph", function(t) {
                ...
                e.setVisual("fromSymbol", n && n[0]), e.setVisual("toSymbol", n && n[1]), e.setVisual("fromSymbolSize", o && o[0]), e.setVisual("toSymbolSize", o && o[1]), e.setVisual("color", t.get("lineStyle.normal.color")), e.each(function(t) {
                    var n = e.getItemModel(t),
                        o = i(n.getShallow("symbol", !0)),
                        a = i(n.getShallow("symbolSize", !0));
        ...
        n.prototype = {
            update: function(t, e, i, n, a, r) {
                var s = this._getBrush(),
                    ...
                    h = this._getGradient(t, a, "outOfRange"),
                    ...
                    if (!isNaN(o)) {
                        var f = new r.Rect({
                                ...
                                style: {
                                    ...
                                    opacity: h.getItemVisual(u, "opacity")
                                }
                            }),
        ...
        c._updateEffectSymbol = function(t, e) {
            ...
            this._symbolType === s && d === this._period || (c = h.createSymbol(s, -.5, -.5, 1, 1, u), c.ignore = !0, c.z2 = 100, this._symbolType = s, this._period = d, this.add(c), c.__t = 0, c.animate("", !0).when(d, {
                __t: 1
            }).delay(e / t.count() * d / 2).during(l.bind(a, c)).start()), c.setStyle("shadowColor", u), c.setStyle(n.getItemStyle(["color"])), c.attr("scale", r);
        ...
        c._createContent = function(t, e, i) {
            ...
            this.add(new l.Polygon({
                shape: {
                    points: i ? o(n.bodyEnds, r, n) : n.bodyEnds
                },
                style: {
                    strokeNoScale: !0
                },
            ...
            }, n, e), r(this.childAt(this.whiskerIndex), {
                shape: a(o.whiskerEnds)
        ...
        t.exports = function(t) {
            t.eachSeriesByType("lines", function(t) {
                ...
                i.each(a, function(t, n, o) {
                    ...
                    var e, a = i.getItemLayout(t),
                        r = n.getItemLayout(t),
                        s = o.getItemModel(t).get("lineStyle.normal.curveness");
        ...
        var o = i(1),
            a = ["x", "y", "x2", "y2", "width", "height", "map", "roam", "center", "zoom", "scaleLimit", "label", "itemStyle"],
            r = {};
        t.exports = function(t) {
            var e = [];
        ...
        t.exports = r.extend({
            ...
            getInitialData: function(t, e) {
                var i = e.getComponent("parallel", this.get("parallelIndex")),
                    ...
                    l = t.data,
                    h = a.map(r, function(t, i) {
                        var o = e.getComponent("parallelAxis", s[i]);
                        return "category" === o.get("type") ? (n(o, t, l), {
                            name: t,
                            type: "ordinal"
                        }) : t
                    }),
        ...
        function n(t, e, i) {
            ...
            return a.setShape(r, 0), s.initProps(a, {
                shape: {
                    width: o.width,
                    height: o.height
                }
                ...
                render: function(t, e, i, r) {
                    ...
                    function u(e, i) {
                        ...
                        o(n, m, g, function(i, n) {
                            var o = r.childAt(h++);
                            i && !o ? l.push(a(i)) : i && s.updateProps(o, {
                                shape: {
                                    points: i
                                }
                            }, t, e)
        ...
        t.exports = function(t, e) {
            t.eachSeriesByType("parallel", function(e) {
                var i = e.getModel("itemStyle.normal"),
                    n = t.get("color"),
                    o = i.get("color") || n[e.seriesIndex % n.length],
            ...
            render: function(t, e, i) {
                ...
                function l(e, i, n, a, r, l) {
                    ...
                    for (var h = 0; h < i.length - 1; h++) {
                        var u = s(a, r);
                        u && (u.__dimIdx = h, e[h] ? (u.attr("position", e[h]), o[l ? "initProps" : "updateProps"](u, {
                            position: i[h]
                        }, t, r)) : u.attr("position", i[h]), n.add(u))
                    }
                }
                ...
                d.diff(f).add(function(e) {
                    ...
                    u.eachChild(function(e) {
                        ...
                        }), o.setText(e.hoverStyle, b, f), e.hoverStyle.text = b.get("show") ? a.retrieve(t.getFormattedLabel(i, "emphasis", null, e.__dimIdx), n) : ""
            ...
            render: function(t, e, i) {
                ...
                this._model = t, l.removeAll(), l.position = [h.x, h.y], s.eachNode(function(e) {
                    var i = e.getLayout(),
                        ...
                        h = n.getModel("label.emphasis"),
                        c = h.getModel("textStyle"),
                        d = new o.Rect({
                            shape: {
                                x: i.x,
                                y: i.y,
                    ...
                    }, n.getModel("itemStyle.normal").getItemStyle())), o.setHoverStyle(d, a.extend(e.getModel("itemStyle.emphasis"), {
        ...
        function c(t, e, i) {
            I.each(t, function(t) {
                ...
                if (o = r - e - i, o > 0) {
                    ...
                    for (n.setLayout({
                            y: l
                        }, !0), r = n.getLayout().y, a = s - 2; a >= 0; --a) n = t[a], o = n.getLayout().y + n.getLayout().dy + e - r, o > 0 && (l = n.getLayout().y - o, n.setLayout({
                        y: l
                    }, !0)), r = n.getLayout().y
                }
            })
        ...
        function x(t, e) {
            ...
            if (1 === arguments.length)
                for (; ++a < o;) i = +t[a], isNaN(i) || (n += i);
            else
                for (; ++a < o;) i = +e.call(t, t[a], a), isNaN(i) || (n += i);
            return n
        }
            ...
            _renderContent: function(t, e, i, n, l) {
                for (var u = 0, c = i.emptyItemWidth, d = t.get("height"), f = r.getAvailableSize(i.pos, i.box), p = i.totalWidth, g = i.renderList, m = g.length - 1; m >= 0; m--) {
                    ...
                    p > f.width && (p -= y - c, y = c, x = ""), this.group.add(new a.Polygon({
                        shape: {
                            points: o(u, 0, y, d, m === g.length - 1, 0 === m)
                        },
        ...
        function o(t, e, i, n, o, l, h, u, c, d) {
            function f(e) {
                ...
                p(O, function() {
                    var t = {
                        ...
                        e = h.getModel("itemStyle.emphasis").getItemStyle();
            ...
            function x(t, n, r, s) {
                var l = null != P && i[t][P],
                    h = o[t];
                return l ? (i[t][P] = null, w(h, l, t)) : C || (l = new n({
                    z: a(r, s)
                }), l.__tmDepth = r, l.__tmStorageName = t, A(h, l, t)), e[t][D] = l
            }
        ...
        t.exports = i(2).extendChartView({
            ...
            render: function(t, e, i, n) {
                ...
                if (!(r.indexOf(o, t) < 0)) {
                    ...
                    var a = h.retrieveTargetInfo(n, t),
                        s = n && n.type,
                        l = t.layoutInfo,
                        u = !this._oldTree,
                        c = this._storage,
                        d = "treemapRootToNode" === s && a && c ? {
            ...
            _doRender: function(t, e, i) {
                ...
                var u = e.getData().tree,
                    ...
                    p = this._storage,
                    g = [],
                    m = r.curry(o, e, f, p, i, d, g);
                a(u.root ? [u.root] : [], c && c.root ? [c.root] : [], t, u === c || !c, 0);
                var v = s(p);
                return this._oldTree = u, this._storage = f, {
                    lastsForAnimation: d,
                    willDeleteEls: v,
                    renderFinally: h
                }
                    ...
                    y(e.willDeleteEls, function(t, e) {
                        ...
                        y(t, function(t, n) {
                            var l = e.lastsForAnimation[i][n],
                                h = {};
                            l && ("nodeGroup" === i ? l.old && (h.position = t.position.slice(), t.position = l.old) : (l.old && (h.shape = r.extend({}, t.shape), t.setShape(l.old)), l.fadein ? (t.setStyle("opacity", 0), h.style = {
                                opacity: 1
            ...
            _onZoom: function(t, e, i) {
                if (this._mayClick = !1, "animating" !== this._state) {
                    ...
                    var o = n.getLayout();
                    if (!o) return;
                    var a = new d(o.x, o.y, o.width, o.height),
            ...
            _renderBreadcrumb: function(t, e, i) {
                function n(e) {
                    "animating" !== this._state && (h.aboveViewRoot(t.getViewRoot(), e) ? this._rootToNode({
                        node: e
                    }) : this._zoomToNode({
                        node: e
                    }))
                ...
                })), (this._breadcrumb || (this._breadcrumb = new u(this.group, g(n, this)))).render(t, e, i.node)
            },
            remove: function() {
        ...
        for (var n = i(2), o = i(160), a = function() {}, r = ["treemapZoomToNode", "treemapRender", "treemapMove"], s = 0; s < r.length; s++) n.registerAction({
            type: r[s],
            update: "updateView"
        }, a);
        n.registerAction({
        ...
        function n(t, e, i) {
            ...
            t.eachComponent(n, function(t) {
                var n = e.getWidth(),
                    ...
                    A = v.getPathToRoot(M);
                if ("treemapMove" !== g) {
                    var I = "treemapZoomToNode" === g ? c(t, x, M, l, h) : _ ? [_.width, _.height] : [l, h],
                        T = r.sort;
        ...
        function l(t, e, i) {
            ...
            if (e && e.length)
                if ("value" === s && i) r = [e[e.length - 1].getValue(), e[0].getValue()], "asc" === i && r.reverse();
                else {
                    var r = [1 / 0, -(1 / 0)];
                    S(e, function(t) {
                        var e = t.getValue(s);
        ...
        function u(t, e, i, n, o, a) {
            ...
            if (o) {
                var s = o.type,
                    ...
                    h = "index" === l ? n : "id" === l ? a.mapIdToIndex(i.getId()) : i.getValue(t.get("visualDimension"));
        ...
        i(2).extendComponentView({
            ...
            _axisTick: function(t, e, i, r) {
                var s = t.getModel("axisTick"),
                    ...
                    h = o.map(i, function(t) {
                        return new a.Line({
                            shape: n(e, r[1], r[1] + l, t)
                        })
                    });
                this.group.add(a.mergePath(h, {
        ...
        "use strict";
        i(202), i(300), i(311), i(2).extendComponentView({
            type: "polar"
        })
    }, function(t, e, i) {
        i(345), i(346), i(310)
            ...
            _buildSplitLineAndArea: function(t) {
                ...
                if (r.length) {
                    ...
                    var m = [],
                        v = [];
                    if ("circle" === s)
                        for (var y = r[0].getTicksCoords(), x = i.cx, _ = i.cy, b = 0; b < y.length; b++) {
                            if (d) {
                                var w = e(m, p, b);
                            ...
                            for (var S = o.map(r, function(t, e) {
        ...
        t.exports = u.extend({
            ...
            _layout: function(t, e) {
                ...
                var m, v, y, x, _ = u.get("position", !0),
                    ...
                    S = c && u.get("showPrevBtn", !0),
                    M = c && u.get("showNextBtn", !0),
                    A = 0,
                    I = h;
            ...
            _ = r.extend({
                ...
                _renderEndsText: function(t, e, i) {
                    if (e) {
                        ...
                        var o = this.visualMapModel,
                            ...
                            h = this._applyTransform([r[0] / 2, 0 === i ? -a : r[1] + a], l),
                ...
                _renderBar: function(t) {
                    var e = this.visualMapModel,
                        ...
                        a = this._orient,
                        r = this._useHandle,
                        s = d.getItemAlign(e, this.api, o),
                        h = i.barGroup = this._createBarGroup(s);
                ...
                _createHandle: function(t, e, i, a, r) {
                    var h = l.bind(this._modifyHandle, this, e),
                        u = n(o(e, a), h, "move");
                    ...
                    this.group.add(d);
                    var f = ["horizontal" === r ? a / 2 : 1.5 * a, "horizontal" === r ? 0 === e ? -(1.5 * a) : 1.5 * a : 0 === e ? -a / 2 : a / 2],
                        p = this._shapes;
                ...
                _showIndicator: function(t, e) {
                    ...
                    if (u) {
                        ...
                        u.setStyle("fill", d);
                        var p = s.applyTransform(h.indicatorLabelPoint, s.getTransform(u, this.group)),
                            g = h.indicatorLabel;
                        g.attr("invisible", !1);
                        var m = this._applyTransform("left", h.barGroup),
                            v = this._orient;
                        g.setStyle({
                ...
                _enableHoverLinkToSeries: function() {
                    function t(t) {
                        ...
                        if (e.option.hoverLink) {
                            var n = this._applyTransform([t.offsetX, t.offsetY], this._shapes.barGroup, !0, !0),
                                o = [n[1] - y / 2, n[1] + y / 2],
                                a = [0, i[1]],
                                r = e.getExtent(),
                                s = [f(o[0], a, r, !0), f(o[1], a, r, !0)];
                            ...
                            var h = p(this._hoverLinkDataIndices),
                                u = d.removeDuplicateBatch(l, h);
                            this.api.dispatchAction({
                                type: "downplay",
                                batch: u[0]
                            }), this.api.dispatchAction({
        ...
        var n = i(216),
            ...
            h = n.extend({
                ...
                _getRepresentValue: function(t) {
                    var e;
                    if (this.visualMapModel.isCategory()) e = t.value;
        ...
        for (var n = i(223), o = [126, 25], a = [
            ...
            for (var s = 0; s < a[r].length; s++) a[r][s][0] /= 10.5, a[r][s][1] /= -14, a[r][s][0] += o[0], a[r][s][1] += o[1];
        t.exports = function(t) {
        ...
        function n(t) {
            ...
            for (var e = t.features, i = 0; i < e.length; i++)
                for (var n = e[i], a = n.geometry, r = a.coordinates, s = a.encodeOffsets, l = 0; l < r.length; l++) {
                    var h = r[l];
                    if ("Polygon" === a.type) r[l] = o(h, s[l]);
            ...
            _init: function(t, e, i) {
                ...
                u(n, function(t, i) {
                    var n = o[i],
                        ...
                        l = this._axesMap[t] = new s(t, a.createScaleByModel(r), [0, 0], r.get("type"), n),
                        h = "category" === l.type;
                ...
                for (var l = 0, h = t.count(); h > l; l++) {
                    ...
                    if (a) {
                        ...
                        for (var r = 0, s = n.length; s > r; r++) {
                            var d = n[r],
                                f = o[d].model.getActiveState(c[r], r);
                            if ("inactive" === f) {
                                u = "inactive";
                                break
                            }
        ...
        n.prototype.getIndicatorAxes = function() {
            ...
            o.each(n, function(t, e) {
                ...
                var o = t.model,
                    ...
                    u = o.get("max"),
                    c = a.getInterval();
                if (null != h && null != u) a.setInterval((u - h) / r);
                else if (null != h) {
                    var d;
            ...
            if (e instanceof n || (e = this._nodesMap[e]), e) {
                ...
                if (!t.call(o, e, null))
                    for (var s = [e]; s.length;)
                        for (var l = s.shift(), h = l[a], r = 0; r < h.length; r++) {
                            var u = h[r],
        ...
        u.prototype = {
            ...
            function a(t, e) {
                ...
                var n = t.children;
                if (n)
                    for (var s = 0; s < n.length; s++) a(n[s], i)
            }
            var r = new n(e, i),
                c = [];
