 ...
 * 
 * @Slf4j public class UReviewAjController {
 * 
 ...
 * @GetMapping("/lybalb")
 * 
 * @ResponseBody public List<UReview> reviewJsonView(Model model) {
 * 
 * List<UReview> uReviewList = uReviewService.getUReviewList(null);
 ...
 * uReviewList);
 * 
 * return "user/review/reviewList"; return uReviewList; }
 * 
 * @GetMapping("/list") public String reviewList(Model model) {
 * 
 ...
 * 
 * @GetMapping("/list2") public String reviewList2() { return
 * "user/review/reviewList2"; }
 * 
 * @GetMapping("/list3") public String reviewList3() { return
 * "user/review/reviewList3"; }
 * 
 * @GetMapping("/list4") public String reviewList4() { return
 * "user/review/reviewList4"; }
 * 
 * @GetMapping("/list5") public String reviewList5() { return
 * "user/review/reviewList5"; }
 * 
 * }
 */